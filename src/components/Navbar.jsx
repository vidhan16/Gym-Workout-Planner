    ...
    <div className='sticky top-0 z-50'>
      <div className='parent flex items-center h-[7vw] w-full bg-black'>
        ...
        <div className='shift_right absolute right-3.5'>
          <Link to='/'>
            <button className='hover:bg-zinc-800 hover:text-white'>Home</button>
          </Link>
          <Link to='/Muscles'>
            <button className='hover:bg-zinc-800 hover:text-white'>Exercises</button>
          </Link>
          <button className='hover:bg-zinc-800 hover:text-white'>About Us</button>
          <Link to='/Signin'>
            <button className='hover:bg-zinc-800 hover:text-white'>{name!=null ? `Hi, ${name.toUpperCase().replace(/[^a-zA-Z]+/g, "")}` :'LOGIN'}</button>
          </Link>
      ...
      <Link to='/Muscles'><button onClick={openi} className='p-2  w-full'>Exercises</button></Link>
          ...
          <Link to='/Signin'><button onClick={openi} className='p-2  w-full'>{name!=null && name!="index.html" ? `Hi, ${name.toUpperCase().replace(/[^a-zA-Z]+/g, "")}` :'LOGIN'}</button></Link>
        </div>
    </div>
  );
};
